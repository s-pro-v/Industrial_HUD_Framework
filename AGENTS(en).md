...
Respond to the user in the language they use. When generating UI strings (labels, buttons, messages), use the same language as the project context or the user’s request.
